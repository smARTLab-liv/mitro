...
namespace pr2_msgs
{
  ...
  class AccessPoint : public ros::Msg
  {
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      uint32_t * length_essid = (uint32_t *)(outbuffer + offset);
      *length_essid = strlen( (const char*) this->essid);
      offset += 4;
      memcpy(outbuffer + offset, this->essid, *length_essid);
      offset += *length_essid;
      uint32_t * length_macaddr = (uint32_t *)(outbuffer + offset);
      *length_macaddr = strlen( (const char*) this->macaddr);
      offset += 4;
      ...
      *(outbuffer + offset + 3) = (u_channel.base >> (8 * 3)) & 0xFF;
      ...
      uint32_t * length_rate = (uint32_t *)(outbuffer + offset);
      *length_rate = strlen( (const char*) this->rate);
      offset += 4;
      memcpy(outbuffer + offset, this->rate, *length_rate);
      offset += *length_rate;
      uint32_t * length_tx_power = (uint32_t *)(outbuffer + offset);
      *length_tx_power = strlen( (const char*) this->tx_power);
      offset += 4;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      uint32_t length_essid = *(uint32_t *)(inbuffer + offset);
      offset += 4;
      ...
      offset += length_essid;
      uint32_t length_macaddr = *(uint32_t *)(inbuffer + offset);
      offset += 4;
      ...
      offset += sizeof(this->channel);
      uint32_t length_rate = *(uint32_t *)(inbuffer + offset);
      offset += 4;
      ...
      offset += length_rate;
      uint32_t length_tx_power = *(uint32_t *)(inbuffer + offset);
      offset += 4;
