...
namespace pr2_msgs
{
  ...
  class GPUStatus : public ros::Msg
  {
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      uint32_t * length_product_name = (uint32_t *)(outbuffer + offset);
      *length_product_name = strlen( (const char*) this->product_name);
      offset += 4;
      memcpy(outbuffer + offset, this->product_name, *length_product_name);
      offset += *length_product_name;
      uint32_t * length_pci_device_id = (uint32_t *)(outbuffer + offset);
      *length_pci_device_id = strlen( (const char*) this->pci_device_id);
      offset += 4;
      memcpy(outbuffer + offset, this->pci_device_id, *length_pci_device_id);
      offset += *length_pci_device_id;
      uint32_t * length_pci_location = (uint32_t *)(outbuffer + offset);
      *length_pci_location = strlen( (const char*) this->pci_location);
      offset += 4;
      memcpy(outbuffer + offset, this->pci_location, *length_pci_location);
      offset += *length_pci_location;
      uint32_t * length_display = (uint32_t *)(outbuffer + offset);
      *length_display = strlen( (const char*) this->display);
      offset += 4;
      memcpy(outbuffer + offset, this->display, *length_display);
      offset += *length_display;
      uint32_t * length_driver_version = (uint32_t *)(outbuffer + offset);
      *length_driver_version = strlen( (const char*) this->driver_version);
      offset += 4;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      uint32_t length_product_name = *(uint32_t *)(inbuffer + offset);
      offset += 4;
      ...
      offset += length_product_name;
      uint32_t length_pci_device_id = *(uint32_t *)(inbuffer + offset);
      offset += 4;
      ...
      offset += length_pci_device_id;
      uint32_t length_pci_location = *(uint32_t *)(inbuffer + offset);
      offset += 4;
      ...
      offset += length_pci_location;
      uint32_t length_display = *(uint32_t *)(inbuffer + offset);
      offset += 4;
      ...
      offset += length_display;
      uint32_t length_driver_version = *(uint32_t *)(inbuffer + offset);
      offset += 4;
