...
static const char SETJOINTTRAJECTORY[] = "gazebo_msgs/SetJointTrajectory";
  ...
  class SetJointTrajectoryRequest : public ros::Msg
  {
    ...
    {
      int offset = 0;
      uint32_t * length_model_name = (uint32_t *)(outbuffer + offset);
      *length_model_name = strlen( (const char*) this->model_name);
      offset += 4;
    ...
    {
      int offset = 0;
      uint32_t length_model_name = *(uint32_t *)(inbuffer + offset);
      offset += 4;
