...
namespace mitro_diagnostics
{
  ...
  class SysInfo : public ros::Msg
  {
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      uint32_t * length_hostname = (uint32_t *)(outbuffer + offset);
      *length_hostname = strlen( (const char*) this->hostname);
      offset += 4;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      uint32_t length_hostname = *(uint32_t *)(inbuffer + offset);
      offset += 4;
    ...
    const char * getMD5(){ return "8a18c921f93816dafb8880f64c77a1c6"; };
