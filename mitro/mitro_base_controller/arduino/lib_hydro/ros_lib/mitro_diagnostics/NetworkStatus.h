  ...
  class NetworkStatus : public ros::Msg
  {
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *(outbuffer + offset + 3) = (u_wifi_signallevel.base >> (8 * 3)) & 0xFF;
      ...
      u_ethernet_status.real = this->ethernet_status;
      *(outbuffer + offset + 0) = (u_ethernet_status.base >> (8 * 0)) & 0xFF;
      offset += sizeof(this->ethernet_status);
      return offset;
    }
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      u_ethernet_status.base = 0;
      u_ethernet_status.base |= ((uint8_t) (*(inbuffer + offset + 0))) << (8 * 0);
      this->ethernet_status = u_ethernet_status.real;
      offset += sizeof(this->ethernet_status);
     return offset;
    }

    const char * getType(){ return "mitro_diagnostics/NetworkStatus"; };
    const char * getMD5(){ return "a0b8c9c15285ff720cd5565a9a975be1"; };
